    ...
    <>
      ...
      <section className="section-4">
        <div className="sous-bg">
          <h3>The Beauty</h3>
          <h1>LOOK BOOK</h1>
          <div className="play-icone" onClick={openModal}><p>play video</p></div>
        </div>
      </section>
      ...
      <iframe width="887" height="499" src="https://www.youtube.com/embed/gBO_Rieyzl8" title="Gojo 😈🔥😳 - jujutsu kaisen EDIT 🔥" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>      </div>
