            ...
            <section className="section-panier">
                ...
                <div className="all-card-product">
                    <div className="produit">
                        ...
                        <div className="p-b"><p className="text-gray">${price}</p>
                        <button>ADD</button>
                        </div>
                    ...
                    <div className="produit">
                        ...
                        <div className="p-b"><p className="text-gray">$19</p>
                        <button>ADD</button>
                        </div>
